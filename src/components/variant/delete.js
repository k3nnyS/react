...
export default ({ deleteVariant, handleClose, handleSubmit, variant: {categoryId, initial, name, active} }) => {
    return <Fragment>
        <Dialog open={deleteVariant} onClose={handleClose}>
            ...
            <DialogContent>
                ...
                <form>
                    <TextField label="Category ID" value={categoryId} margin="normal" disabled={true} />
                    <br />
